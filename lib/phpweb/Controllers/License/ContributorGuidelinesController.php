<?php
	...
	class ContributorGuidelinesController implements ControllerInterface
	{
		...
		public function __invoke(Request $request, ?callable $next): Response {
			return $request
				...
				->setPageTitle('PHP Contributor Guidelines for Core Developers')
		...
		public function renderContents() {
			?>
            <p>
                Before you complete the form to request a Git account, you must understand and accept the principles
                under which PHP
                itself is developed. These are summarised in the next paragraph.
            </p>
            <p>
                Any code contributed to PHP must be contributed under the PHP license (or a compatible BSD-style
                license).
