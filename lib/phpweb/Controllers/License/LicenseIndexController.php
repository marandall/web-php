<?php
	...
	namespace phpweb\Controllers\License;
	...
	class LicenseIndexController implements ControllerInterface
    {
	    ...
	    public function __invoke(Request $request, ?callable $next): Response {
		    return $request
                ...
                ->addSidePanel(new BasicCallbackPanel('', [$this, 'renderPanel']))
			    ->setPageTitle('License Information')
		...
		public function renderContents() {
            ...
            <ul>
                <li>
                    ...
                    <a href="http://www.php.net/license/3_01.txt">PHP License v3.01</a>, copyright (c) the <a
                            href="/credits.php">PHP Group</a>.
                    <ul>
                        <li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="/public/static/license/distrib-guidelines-code.php">Distributing PHP</a></li>
                        <li><a href="/public/static/license/contrib-guidelines-code.php">Contributing to PHP</a></li>
                    </ul>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    ...
                    <a href="http://creativecommons.org/licenses/by/3.0/legalcode">Creative Commons Attribution 3.0
                        License</a>,
            ...
            <ul>
                <li>The Logo license terms can be viewed on the <a href="/download-logos.php">Logo and Icon Download
                        page</a></li>
            </ul>
