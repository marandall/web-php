<?php
	...
	class GetInvolvedController  implements ControllerInterface
	{
		...
		public function renderContents() {
            ...
            <section class="r2-sec" id="ways_to_contribute">
                <h2>Four Best Ways to Contribute</h2>
                <div>
                    <ol class="content-box listed">
                        <li>Running test suites in <a href="http://qa.php.net/">RC</a>
                            and <a href="/versions/">release</a> distributions of PHP</li>
            ...
            <section class="r2-sec" id="development">
                <h2>Development of the PHP source</h2>
                <div>
                    <p>
            ...
            <section class="r2-sec" id="useful_links">
                <h2>Useful links for developers</h2>
                <div>
