<?php
	...
	class InstallBranchWindowsIISController implements ControllerInterface
	{
		...
		public function renderContents(Branch $branch) {
            ...
            <section class="r2-sec">
                <div>
                    <p style="float: right">
                        <img src="/static/images/logos/installers/iis.png" alt="IIS"
            ...
            <section class="r2-sec">
                ...
                <div>
                    ...
                    <p>
                        We will assume this is for development purposes, so begin by renaming
                        <em>php.ini-development</em>
                        to <em>php.ini</em>.
                    </p>
                </div>
            </section>
            ...
            <section class="r2-sec">
                ...
                <div>
                    <p>
                        Running PHP on IIS is most effective using FastCGI. This is a protocol built in to many
                        webservers
                    ...
                    <p>
                        Good general settings for <em>Instance MaxRequests</em> is 2000, and <em>Max Instances</em>
                        should
            ...
            <section class="r2-sec">
                ...
                <div>
                    <p>
                        Now that you have FastCGI configured to use PHP, you will need to attach it to your site as a
                        handler
                        mapping.
                    </p>
                    <p>
                    ...
                    <p>
                        Select the <em>Add Module Mapping</em> option from the right hand side to open up the
                        configuration
                        dialog screen.
                    </p>

                    <p>
                        The <em>request path</em> is which types of file this handler is to process, we want to just
                        handle php
                        files
                        so we add <em>*.php</em>.
                    </p>
                    ...
                    <p>
                        The <em>Executable</em> will be the full path to the <em>php-cgi.exe</em> that you unzipped
                        earlier.
                        This
                        MUST be identical to the path that you entered while configuring the FastCGI executable in the
                        previous
                        step.
                    </p>
                    <p>
            ...
            <section class="r2-sec">
                ...
                <div>
                    <p>
                        The easiest way to check that PHP has been installed correctly is to try printing the PHP
                        information
                        dump.
                    </p>
                    <p>
                        In the root of your webserver directory (the directory hosting your site, NOT the directory you
                        unzipped
                    ...
                    <p>
                        Open your web browser and navigate to the site name that you configured and append info.php onto
                        the
                        URL.
                    </p>
                    <p>
            ...
            <section class="r2-sec">
                ...
                <div>
                    ...
                    <p>
                        ...
                        directory. That's easy enough as the INI file already has that setting prepared, it's just
                        commented
                        out.
                    </p>
                    <p>
                        Search for the following line, and remove the semicolon at the start. This will &quot;uncomment&quot;
                        the configuration option and make it active. This will let PHP know to look in the ext directory
                        to find
                        extension files.
                    </p>
