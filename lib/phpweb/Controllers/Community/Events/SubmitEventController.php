<?php
	...
	class SubmitEventController  implements ControllerInterface
	{
				...
				<table border="0" cellpadding="3" class="standard">
					<tr>
						...
						<td>
							...
							<input type="text" name="syear" size="4" maxlength="4" value="<?php echo $_POST['syear'] ? htmlentities((string)$_POST['syear'], ENT_QUOTES | ENT_IGNORE, 'UTF-8') : date(
								'Y'
							)?>">
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="eyear" size="4" maxlength="4" value="<?php echo $_POST['eyear'] ? htmlentities((string)$_POST['eyear'], ENT_QUOTES | ENT_IGNORE, 'UTF-8') : date(
								'Y'
							)?>">
					...
					<tr>
						...
						<td><select name="sane"><?php $this->display_options(array('I, Robot', 'I used to be', 'WTF?', "No, but I'd still want to submit this", 'Yes'),
									'2'
								); ?></select></td>
					</tr>
				</table>
