	...
	class PHP3ManualArchiveController implements ControllerInterface
	{
		...
		public function renderContents() {
            ...
            <dl>
                ...
                <dd>
                    <p>
                        <em>--with-mck[=DIR]</em> includes Cybercash MCK support. DIR is the cybercash mck build
                        directory,
            ...
            <dl>
                ...
                <dd>
                    <p>
                        Objects lose their class association throughout the process of serialization and
                        unserialization.
                    </p>
                </dd>
                <dd>
