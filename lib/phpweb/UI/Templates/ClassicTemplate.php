<?php
	...
	class ClassicTemplate implements RendererInterface
	{
		public function render(PHPWebTemplate $tpl, callable $body) {
			...
			<head>
				...
				<?php foreach ($tpl->getCssFiles() as $filename): ?>
			...
			<div id="layout" class="clearfix">
				<section id="layout-content">
					<h1><?= htmlspecialchars($tpl->getPageTitle()) ?></h1>
				...
				<?php foreach ($tpl->getSidePanels() as $panel) { ?>
					<aside>
