...
?>
<?php foreach (\phpweb\Data\Versions::GetVersions() as $MAJOR => $major_releases): /* major releases loop start */
...
<?php
	...
	foreach (\phpweb\Data\Versions::GetVersions() as $MAJOR => $major_releases): /* major releases loop start */
		$releases = array_slice($major_releases, 0, $SHOW_COUNT);
		?>
